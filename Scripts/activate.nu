...
let virtual-env = "C:\Program Files (x86)\Anaconda\envs\target-detector-yolov5-main"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "C:\Program Files (x86)\Anaconda\envs\target-detector-yolov5-main\Scripts\deactivate.nu"
